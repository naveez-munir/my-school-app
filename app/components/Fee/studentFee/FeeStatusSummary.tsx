...
export function FeeStatusSummary({ summary }: FeeStatusSummaryProps) {
  const totalAmount = summary.totalPending;
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-3xl font-bold mt-2 text-yellow-600">{formatCurrency(summary.totalPending)}</p>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-3xl font-bold mt-2 text-red-600">{formatCurrency(summary.totalOverdue)}</p>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-3xl font-bold mt-2 text-blue-600">{formatCurrency(totalAmount)}</p>
