...
import { FeeStatus } from '~/types/studentFee';

type StatusValue = FeeStatus | 'all';
...
interface FeeStatusSelectorProps {
  value?: StatusValue;
...
export function FeeStatusSelector({
  value,
  onChange,
  label = 'Fee Status',
  required = false,
